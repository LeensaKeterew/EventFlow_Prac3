...
class Booth : public EventUnit, public Subject {
    public:
        ...
        /// @brief using this to stimulate people joining the queue which is for testing
        void addToQueue(int people); 
